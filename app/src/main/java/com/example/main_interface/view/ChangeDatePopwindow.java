package com.example.main_interface.view;
...
import com.example.main_interface.R;
import com.example.main_interface.view.wheelview.OnWheelChangedListener;
import com.example.main_interface.view.wheelview.OnWheelScrollListener;
import com.example.main_interface.view.wheelview.WheelView;
import com.example.main_interface.view.wheelview.adapter.AbstractWheelTextAdapter1;
...
//      this.setAnimationStyle(R.style.AnimBottom);
    ...
    public void initYears() {
        for (int i = Integer.parseInt(getYear()); i > 1950; i--) {
            arry_years.add(String.valueOf(i));
        }
    }
    ...
    public void initMonths(int months) {
        ...
        for (int i = 1; i <= months; i++) {
            arry_months.add(String.valueOf(i));
        }
    }
    ...
    public void initDays(int days) {
        ...
        for (int i = 1; i <= days; i++) {
            arry_days.add(String.valueOf(i));
        }
    }
